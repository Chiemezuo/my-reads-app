//Out of curiosity, I wanted to have an idea of what the data from the method call would look like.
//I tried copying and pasting the code into the browser console. Not much luck there.
//I played around on the internet and got some tips on how to do it.
//I ended up using a website called postman to successfully get the JSON output
